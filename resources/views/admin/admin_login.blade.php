...
<head>
  ...
  <title>Arif Admin Login Page</title>
            ...
            <div class="card">
              <div class="row">
                <div class="col-md-4 pe-md-0">
                  <div class="auth-login-side-wrapper"></div>
                </div>
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Arif<span>Learning</span></a>
                    ...
                    <form class="forms-sample" action="{{ route('login') }}" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="login" class="form-control" id="login" autocomplete="username" placeholder="Email/Name/Phone">
                      </div>
                      <div class="mb-3">
